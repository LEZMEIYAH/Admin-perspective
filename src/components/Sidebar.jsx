...
const Sidebar = () => {
  const SIDEBAR_LINKS = [
    ...
    { id: 2, path: "/patients", name: "Patients", icon: FiUser },
    { id: 3, path: "/users", name: "Users", icon: FaUserMd },
    { id: 4, path: "/prescriptions", name: "Prescriptions", icon: FaPrescriptionBottleAlt },
    { id: 5, path: "/calendar", name: "Calendar", icon: MdOutlineCalendarToday },
    { id: 6, path: "/profile", name: "Profile", icon: FiUser },
  ];
